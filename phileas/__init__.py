    ...
    class Element:
        ...
        def __add__(self, other):
            """ This custom function was introduced very late in the development in order to
                facilitte the use of '+' instead of ',' for conceatenating elements. This will
                eliminate the need for 'unravel' in most if not all cases.
            """
            if other is None:
                return self  # maybe only approximately correct!
            return _HTML40.Element(tag=None, separateClose=False,
                children= (self.tag is None and self.children or [self])
                        + ((isinstance(other, _HTML40.Element) and other.tag is None and other.children) or [other])
                                   )

        __radd__ = __add__  # + is symmetrical as is often the case!
    ...
    print(
        ...
        h.html | (
            ...
            (h.p |
             ...
             h.br + "abc " * 3 + 4 * 'xyz ' + '\n' +
             3 * h.br +
             """ If you're viewing this output in a browser, you can get to some (possibly not 100% up todate!)
    ...
    print(
        ...
        h.html | (
            ...
            (h.p | (
                ...
                h.br* 5 +
                h.br, "abc " * 3, 4 * 'xyz ' + '\n',
                # two even shorter ways to invoke multpile blank lines:
                h.br * 3,
                3 * h.br,
                """ If you're viewing this output in a browser, you can get to some (possibly not 100% up todate!)
                background info on 'phileas' by clicking """,
